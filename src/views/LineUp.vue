...
import Logo1 from '@/assets/images/redhotcreampastar.png'
import Logo2 from '@/assets/images/lifeafter.png'
// import Logo3 from '@/assets/images/hayeoun.jpg'
import Logo3 from '@/assets/images/hy.png'
import Logo4 from '@/assets/images/umka.jpg'
import Logo5 from '@/assets/images/seoribada.png'
import Logo6 from '@/assets/images/nsnmin.png'
import Member from '@/assets/images/lifeafter_all.png'
import Member2 from '@/assets/images/lifeafter_js.png'
...
onMounted(() => {
  ...
  const lifeafter_all = gsap.timeline({
    repeat: -1,
    yoyo: true,
    duration: 0.1,
  })

  lifeafter_all.to('#member1', {
    rotate: 1,
    ease: 'power4.out',
    scaleY: 0.95,
    skewX: 1,
...
<template>
  <div id="panel_2" class="panel h-dvh justify-items-center content-center">
    <div class="h-1/2 bg-contain bg-center px-4 overflow-hidden">
      <div class="relative">
        <div class="absolute placemat"></div>
      </div>
      <img id="logo1" class="h-full object-contain" :src="Logo1" />
    </div>
    <div>
      <ul>
        <li>RHCP - Can't Stop</li>
        <li>RHCP - Suck My Kiss</li>
        <li>RHCP - By the Way</li>
        <li>RHCP - Black Summer</li>
        <li>RHCP - Under the Bridge</li>
        <li>RHCP - Dani California</li>
      </ul>
    </div>
  </div>

  <div id="panel_3" class="panel h-dvh justify-items-center content-center">
    <div class="heart outermost dark">
      <div class="heart light">
        <div class="heart dark">
          <div class="heart light">
            <div class="heart dark">
              <div class="heart light">
                <div class="heart dark">
    ...
    <div class="h-3/5 bg-contain bg-center px-4">
      <img class="absolute top-12 left-4 max-h-1/15" :src="Logo2" />
      <img class="object-contain z-3 pt-34 max-h-9/10" :src="Member" id="member1" />
      <img class="absolute top-30 max-h-3/20 -z-10" :src="Member2" id="member2" />
    </div>
    <div>
      <ul>
        <li>10cm - 그라데이션</li>
        ...
        <li>10cm - 너에게닿기를</li>
        <li>나상현씨밴드 - 찬란</li>
        <li>하이키 - 건물 사이에 피어난 장미</li>
      </ul>
    </div>
  </div>

  <div id="panel_4" class="panel h-dvh justify-items-center content-center">
    <div class="w-full flex justify-center">
      <div class="w-md relative">
        <div class="note-position-1 note-amination">&#9835;</div>
        <div class="note-position-2 note-amination animation-delay-2">&#9833;</div>
        <div class="note-position-3 note-amination animation-delay-1">&#9839;</div>
        <div class="note-position-4 note-amination">&#9834;</div>
        <div class="note-position-5 note-amination">&#9833;</div>
        <div class="note-position-6 note-amination animation-delay-2">&#9838;</div>
      </div>
    </div>
    <div class="h-1/2 bg-contain bg-center px-4">
      <img class="h-full object-contain" :src="Logo3" />
    </div>
    <div>
      <ul class="underline underline-offset-8">
        ...
        <li>에일리 - 보여줄게</li>
        <li>YB - 붉은 노을</li>
        <li>LUCY - 못 죽는 기사와 비단 요람</li>
      </ul>
    </div>
  </div>

  <div id="panel_5" class="panel h-dvh justify-items-center content-center">
    <div class="infinity-twinkle absolute"></div>
    <div class="h-1/2 bg-contain bg-center px-4">
      <img class="h-full object-contain" :src="Logo4" />
    </div>
    <div>
      <ul>
        <li>AKMU - 물 만난 물고기</li>
        <li>AKMU - 리얼리티&크레센도</li>
        <li>AKMU - 오랜 날 오랜 밤</li>
        <li>AKMU - RE-BYE</li>
        <li>AKMU - Give Love</li>
        <li>AKMU - 시간을 갖자</li>
      </ul>
    </div>
  </div>

  <div id="panel_6" class="panel h-dvh justify-items-center content-center">
    <div class="h-1/2 bg-contain bg-center px-4">
      <img class="h-full object-contain max-h-4/5" :src="Logo5" />
    </div>
    <div>
      <ul>
        <li>레이나 - 선잠</li>
    ...
    <div class="absolute w-full top-0 z-[-1]">
      <div class="beach">
        <div class="beach__waves" />
        <div class="beach__sand beach__sand--background" />
        <div class="beach__sand beach__sand--foreground" />
      </div>
    </div>
  </div>

  <div id="panel_7" class="panel h-dvh justify-items-center content-center">
    <div class="glow"></div>
    <div id="lens"></div>
    <div class="h-1/2 bg-contain bg-center px-4">
      <img id="logo6" class="h-full object-contain" :src="Logo6" />
    </div>
    <div>
      <ul>
        <li>자작곡 - pulse</li>
        <li>Dream Theater - Overture 1928</li>
        <li>Dream Theater - Strange Dejavu</li>
        <li>Stratovarius - Stratasphere</li>
        <li>T-Square - Explorer</li>
        <li>John Petrucci - Glasgow Kiss</li>
      </ul>
    </div>
  </div>
</template>
...
.panel:nth-child(4) {
  ...
  font-family: 'NoonnuBasicGothicRegular';
  ul {
    text-decoration-color: #f29b30 !important;
...
.panel:nth-child(6) {
  background-image: linear-gradient(to top, #84b9bf 20%, #246473 80%);
  background-color: #9cd3d9;
  font-family: 'GowunDodum-Regular';
  font-weight: bold;
}
.panel:nth-child(7) {
...
.placemat {
  ...
  background: white;
  background-image:
    linear-gradient(90deg, hsla(0 100% 39% / 0.5) 50%, transparent 0),
    linear-gradient(hsla(0 100% 39% / 0.5) 50%, transparent 0);
  background-size: 15px 15px;
  border-radius: 4px;
  box-shadow: hsla(0 0% 0% / 0.1) 0 4px 4px -2px;
  transform: scale(0.8);
}
...
.beach {
  ...
  &__sand {
    ...
    &--foreground {
      z-index: 1;
      background: linear-gradient(200deg, $highlight 0%, $red 300%);
      @keyframes seafoam2 {
        0%,
        100% {
...
.glow {
  -webkit-animation: glow-jsx-3892812271 4.1s ease-out 3.5s infinite;
  animation: glow-jsx-3892812271 4.1s ease-out 3.5s infinite;
